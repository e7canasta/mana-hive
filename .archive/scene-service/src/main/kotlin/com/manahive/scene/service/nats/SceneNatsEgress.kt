...
/**
 * Publishes SceneEvents to scene.fact.v1.<bed> JetStream.
 *
...
public class SceneNatsEgress(
     ...
     */
    public fun publishFact(fact: SceneEvent) {
        try {
            val subject = Subjects.sceneEvent(fact.bed)
            val envelope = EventEnvelope(
                eventId = UUID.randomUUID().toString(),
                type = fact::class.simpleName ?: "SceneEvent",
                version = 1,
                occurredAt = fact.at,
                source = "scene-engine",
