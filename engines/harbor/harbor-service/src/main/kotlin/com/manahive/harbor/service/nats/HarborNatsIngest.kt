...
import com.manahive.harbor.NoticeRegistry
 ...
 * to the HarborEngine, maintaining NoticeRegistry state.
 *
...
public class HarborNatsIngest(
    ...
    /** NoticeRegistry state — synchronized for thread safety. */
    @Volatile
    private var registry = NoticeRegistry()
