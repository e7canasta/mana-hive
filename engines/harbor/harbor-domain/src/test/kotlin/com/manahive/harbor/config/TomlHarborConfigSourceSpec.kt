...
class TomlHarborConfigSourceSpec : DescribeSpec({

    describe("TomlHarborConfigSource") {
        describe("load") {
            it("loads from valid TOML file") {
                ...
                try {
                    ...
                    val source = TomlHarborConfigSource(tempDir.absolutePath)
        ...
        describe("subscribe") {
            it("registers callback") {
                ...
                try {
                    ...
                    source.subscribeEscalation("maria") { callbackInvoked = true }
