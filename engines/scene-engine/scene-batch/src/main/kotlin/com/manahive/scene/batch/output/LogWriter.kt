 ...
 * ```json
 * {"ts":"2024-01-01T03:00:02Z","level":"INFO","msg":"transition accepted","from":"LYING","to":"BED_EDGE"}
 * ```
 *
 * Uses Jackson ObjectNode for type-safe JSON construction (Fowler: "Introduce Parameter Object").
 */
