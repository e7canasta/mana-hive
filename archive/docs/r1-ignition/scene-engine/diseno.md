...
The `scene-domain` module is organized into five sub-contexts (`core`, `calibration`, `interpreter`, `sweeper`, `adapter`). See [scene-domain-subcontexts.md](scene-domain-subcontexts.md) for the dependency map and type inventory.
